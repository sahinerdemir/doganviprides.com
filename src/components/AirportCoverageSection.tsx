        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {AIRPORTS_DATA.map((ap) => (
            <StaggerItem key={ap.code}>
              <div className="bg-[#101015] border border-white/5 rounded-2xl p-6 hover:border-white/20 transition-all duration-300 group flex flex-col justify-between h-full">
